...
namespace FlatMate.Module.Lists.Persistence.Repositories
{
    [Inject(typeof(ListRepository))]
    public class ListRepository
    {
        private readonly ListsContext _context;

        public ListRepository(ListsContext context)
        {
            _context = context;
        }
        ...
        public Result Update<T>(T dbo, bool skipSave = false) where T : BaseDbo
        {
            _context.Update(dbo);
            return SaveChanges(skipSave);
        }
